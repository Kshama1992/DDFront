...
import LogEmailListComponent from './log-email-list.component';
	...
	return (
		<BasePage>
			<Helmet>
				...
				<meta name="description" content="Email logs" />
			</Helmet>
				...
				<Grid item xs={12} md={9} xl={10} className={classes.rightSide}>
					<Grid container spacing={3}>
						<Grid item sm={12} xs={12} style={{ position: 'relative' }}>
							<Grid container>
								<Grid item xs={6}>
									<BreadcrumbsComponent primary="Email logs" />
								</Grid>
							</Grid>
						</Grid>
						<Grid item lg={12} md={12} xs={12}>
							<LogEmailListComponent />
						</Grid>
					</Grid>
				</Grid>
			</Grid>
